...
nqcrit = 1.71*1e21/2.65/4
dens_fit = np.copy(dens)
dens_fit[dens < 0.8*nqcrit] = 1e13 # set everything to vacuum

stitline = dens_fit[cix, :]
...
plt.plot(xgv*1e4, stitline, 'g-', label="Modified central lineout")
plt.ylim(-0.1e21, 1.5*1.71*1e21/2.65)
plt.title("LSP initial density (Z=0 lineout)")
plt.xlim(-25, -1)
...
outname = r"C:\Users\Scott\Documents\LSP\Water columns\FLASH sims\f15vacall.dat"
