...
def angular2(s, phi, e, fig=None, ropts=None, oap_deg=60, labels=None, ax=None, log_q=False, phi_spacing=180, cmap=pastel_clear, E_spacing=40, colorbar=True, maxE=4.0, maxQ=None, minQ=None, Estep=1.0, clabel=r'$Charge/MeV/rad (a.u.)$', ltitle=None, rtitle=None, title=None):
    '''
